    ...
    <footer className="border-t border-border py-12 px-4 bg-background/50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* About */}
          <div>
            <h3 className="text-lg font-bold text-gradient mb-4">Sanchita Mishra</h3>
            <p className="text-sm text-foreground/70">
              Full-stack developer building AI-powered solutions with a passion for scalable systems and user experience.
            </p>
          </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="pt-8 border-t border-border text-center text-sm text-foreground/60"
        >
          <p>
            Crafted with <span className="text-accent">passion</span> and built with modern web technologies.
          </p>
          <p className="mt-2">Copyright © 2024 Sanchita Mishra. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  )
